...
\begin{figure}
	\centering
	\includegraphics[width=0.9\columnwidth]{detection/std_1.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\columnwidth]{detection/tiles_4.png}
...
\begin{figure*}[!htb]
	...
	\begin{subfigure}{\columnwidth}
		\centering
		\includegraphics[width=0.5\columnwidth]{detection/tiled_prediction.png}
		\caption{Prediction with $2\times2$ tiling.}
		\label{fig:tiledpred}
	\end{subfigure}
	\begin{subfigure}{\columnwidth}
		\centering
		\includegraphics[width=0.51\columnwidth]{detection/standard_prediction.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\columnwidth]{classification/std_3.png}
