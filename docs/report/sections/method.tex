...
\subsubsection{Spitting the images}
\label{sssec:tiling}
...
We tested some simple variations using different types of residual blocks, and they worked equally well, so we didn't not spend much time experimenting with other architectures.
