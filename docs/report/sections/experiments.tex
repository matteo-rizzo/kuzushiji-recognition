...
\begin{table*}
	...
	\begin{tabular}{lll}
		\rowcolor[HTML]{EFEFEF} 
		\textbf{Experiment} & \textbf{Loss} & \textbf{Accuracy} \\
		ResNet34 + augmentation & 0.2732 & 0.9413 \\
		ResNet34 + no augmentation & ? & ? \\ 
		ResNet34 + no augmentation & 0.4165 & 0.9214 \\
	\end{tabular}
	...
	\begin{tabular}{ll}
		\rowcolor[HTML]{EFEFEF} 
		\textbf{Experiment} & \textbf{Kaggle score} \\
		ResNet34 + tiling + augmentation & 0.780 \\
		ResNet34 + augmentation & 0.606 \\
		ResNet34 + tiling & - \\
		ResNet50 + tiling + augmentation & - \\
		ResNet50 + augmentation & 0.491 \\
		Kaggle model + tiling & - \\
	\end{tabular}
